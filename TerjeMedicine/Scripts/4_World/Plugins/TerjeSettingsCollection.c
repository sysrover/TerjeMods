modded class TerjeSettingsCollection
{
	...
	override void OnInit()
	{
		...
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MIN = RegisterSettingFloat("Medicine.BiohazardLightSymptomIntervalMin", "Medicine", "Minimum time before light (level 1+) biohazard symptoh.", 20, true);
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MAX = RegisterSettingFloat("Medicine.BiohazardLightSymptomIntervalMax", "Medicine", "Maximum time to make light (level 1+) biohazard symptoh.", 40, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MIN = RegisterSettingFloat("Medicine.BiohazardHeavySymptomIntervalMin", "Medicine", "Minimum time before heavy (level 2+) biohazard symptoh.", 200, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MAX = RegisterSettingFloat("Medicine.BiohazardHeavySymptomIntervalMax", "Medicine", "Maximum time to make heavy (level 2+) biohazard symptoh.", 400, true);
