modded class TerjeSettingsCollection
{
	...
	override void OnInit()
	{
		...
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_CHANCE = RegisterSettingFloat("Medicine.BiohazardLightSymptomChance", "Medicine", "Chance to make light (level 1+) biohazard symptoh. Value from 0 to 1.", 0.25, true);
