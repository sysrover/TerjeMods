modded class TerjeSettingsCollection
{
	...
	override void OnInit()
	{
		...
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MIN = RegisterSettingInt("Medicine.BiohazardLightSymptomIntervalMin", "Medicine", "Minimum time before light (level 1+) biohazard symptom.", 20, true);
		MEDICINE_BIOHAZARD_LIGHT_SYMPTOM_INTERVAL_MAX = RegisterSettingInt("Medicine.BiohazardLightSymptomIntervalMax", "Medicine", "Maximum time to make light (level 1+) biohazard symptom.", 40, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MIN = RegisterSettingInt("Medicine.BiohazardHeavySymptomIntervalMin", "Medicine", "Minimum time before heavy (level 2+) biohazard symptom.", 200, true);
		MEDICINE_BIOHAZARD_HEAVY_SYMPTOM_INTERVAL_MAX = RegisterSettingInt("Medicine.BiohazardHeavySymptomIntervalMax", "Medicine", "Maximum time to make heavy (level 2+) biohazard symptom.", 400, true);
